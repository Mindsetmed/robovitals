...
// Cross-origin isolation. The SDK's WASM core uses a SharedArrayBuffer, which
// the browser only allows when the page is crossOriginIsolated. That requires
// BOTH of these response headers on the document and every asset it loads.
// Without them, worker init fails with:
